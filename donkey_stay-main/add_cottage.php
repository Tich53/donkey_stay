...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $createCottage = "INSERT INTO cottage (cottage_name, cottage_region, cottage_city, cottage_country, cottage_nb_bed, cottage_nb_bathroom, cottage_price_per_night, cottage_description, cottage_photo1, cottage_photo2, cottage_photo3, cottage_photo4, cottage_user_iduser) VALUES (:cottage_name, :cottage_region, :cottage_city, :cottage_country, :cottage_nb_bed, :cottage_nb_bathroom, :cottage_price_per_night, :cottage_description, :cottage_photo1, :cottage_photo2, :cottage_photo3, :cottage_photo4, :idUser)";
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section ftco-animate">
                    <h2 class="mb-4" id="title">Ajouter un gîte</h2>
                </div>
            </div>
        </div>
    </section>
