OK-Etape 1: Récupérer l'ID du cottage-OK
OK-Etape 2: créer un formulaire de réservation-OK
Etape 3: Vérifier que les dates soient bien disponible
    => Sélectionner toutes les dates booked_date pour le cottage concerné
Etape 4: Si pas disponible, alors réservation impossible et pas d'INSERT INTO
Etape 5: Insérer les données dans la base de données "booking" quand "POST"
Etape 6: Insérer les données dans la base de données "booked_date" quand "POST"
